...
<main id="primary" class="site-main">
    <div class="about-container">
        ...
        <div class="content-container">
            <!-- This .heading-mobile is outside the .summary-content to not inherit it's styles. -->
            <h1 class="heading-mobile"><?php esc_html_e( 'Περιγραφή Έργου', 'brutus' ) ?></h1>
            ...
            <!-- This .heading-mobile is outside the partners-content <div> to not mess up the grid layout -->
            <h1 class="heading-mobile"><?php esc_html_e( 'Εταίροι', 'brutus' ) ?></h1>
